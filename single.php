...
<div id="single">
    ...
    <div class="single-hero generic-container">
        <h1 class="part1"><?php echo get_field( "name" );?></h1>
        <h3 class="project-blurb part1"><?php echo get_field( "blurb" );?></h3>
        <div class="single-line part1"></div>
        <h2 class="project-type part1"><strong>Product Type: </strong><?php echo get_field( "product" );?></h2>
    ...
    <div id="synopsis" class="generic-container">
    ...
    <div id="techthoughts" class="generic-container">
    ...
    <div id="impact" class="generic-container">
        <div class="single-details-wrapper">
